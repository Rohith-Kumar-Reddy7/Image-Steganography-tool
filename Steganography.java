...
*/
    ...
    public String startCompression(String str,String password) throws Exception
    {
        ...
        //System.out.println(temp2);   //prints the output of the encryption
    ...
    public String startDecompression(String a,String password)throws Exception
    {
        String str, str1 = "", str2 = "", str3;     BigDecimal compDecimalPoint;    int sum = 0, i = 0, j = 0;
        BigDecimal[] freqArr, lineFractionArr;  char[] ch;
    ...
    /*static public void main(String arg[]) throws Exception
    {
        ...
        String b="h of these rounds, whichare computed out of original AES key. All the computationsin AES are performed on bytes rather than bits. 128 bitsof a data block is treated as 16 bytes and is arranged as a4×4 matrix, referred to as state array in AES. An example ofAES encryption is shown in Fig.1.After compression and encryption of secret message, modified approach of Khodaei and Faez’s LSB+PVD method [23]is applied to embed the message in cover image.";
        System.out.println("the real length is "+b.length());
